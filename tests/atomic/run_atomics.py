...
[scanner]
sigma_enabled = true
sigma_rules_path = "{pack_id}/sigma"
yara_enabled = true
yara_rules_path = "{pack_id}/yara"

[ioc]
enabled = true
hashes_path = "{pack_id}/ioc/hashes.txt"
ips_path = "{pack_id}/ioc/ips.txt"
domains_path = "{pack_id}/ioc/domains.txt"
paths_regex_path = "{pack_id}/ioc/paths_regex.txt"
